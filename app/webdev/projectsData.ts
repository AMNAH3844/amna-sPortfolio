...
> = {
  flybook: {
    ...
    media: [{ type: "video", src: "/images/flybook.mp4" }],
  ...
  taskquadrant: {
    ...
    focus:
      ...
      "based on the Eisenhower Matrix that helps users organize tasks according to " +
  ...
  shopsie: {
    ...
    link: "https://github.com/yourusername/shopsie",
  },
};